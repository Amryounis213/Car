                    ...
                    <div class="sign__group">
                        ...
                        <body>
                            ...
                            <main class="main main--sign" data-bg="{{ asset('assets/img/bg/bg.png') }}">
                                ...
                                <div class="sign">
                                    <div class="sign__content">
                                        <form action="{{ route('website.post.register') }}" method="POST"
                                            class="sign__form">
                                            @csrf
                                            <a href="index.html" class="sign__logo">
                                            ...
                                            <div class="sign__group">
                                                <input type="text" name="username" value="{{ old('username') }}"
                                                    class="sign__input" placeholder="User name ex:moh_20">
                                            </div>

                                            <div class="sign__group">
                                                <input type="text" name="phone" value="{{ old('phone') }}"
                                                    class="sign__input" placeholder="Phone">
                                            </div>
                                            ...
                                            <div class="sign__group sign__group--checkbox">
                                                ...
                                                <label for="privacy">I agree to the <a href="privacy.html">Privacy
                                                        Policy</a></label>
                                            </div>
