					...
					<div class="offer">
						...
						<ul class="offer__list">
							...
							<li>
								...
								<span class="offer__list-value offer__list-value--dark">{{$car->number_of_doors}}</span>
							</li>
							<li>
								<span class="offer__list-name">Number of places</span>
								<span class="offer__list-value offer__list-value--dark">{{$car->number_of_places}}</span>
							</li>
							<li>
