                                                ...
                                                <table class="cart__table">
                                                    ...
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td><button class="cart__delete" type="button"
                                    ...
                                    <div class="car">
                                        ...
                                        <div class="car__footer">
                                            ...
                                            <button class="car__favorite car__favorite--active" type="button"
                                                aria-label="Remove from favorites"><svg xmlns="http://www.w3.org/2000/svg"
                                                    viewBox="0 0 24 24">
                                                    <path
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="username" type="text" name="username"
                                                        class="sign__input" placeholder="User123" value="{{ $user->username }}"> 
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="email1" type="text" name="email"
                                                        class="sign__input" placeholder="email@email.com" value="{{ $user->email }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="firstname" type="text" name="firstname"
                                                        class="sign__input" placeholder="John" value="{{ $user->firstname }}" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="lastname" type="text" name="lastname"
                                                        class="sign__input" placeholder="Doe" value="{{ $user->lastname }}">
                                                </div>
                                            </div>
