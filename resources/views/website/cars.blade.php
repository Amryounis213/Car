                            ...
                            <div class="car">
                                <div class="splide splide--card car__slider">
                                    ...
                                    <div class="splide__track">
                                        <ul class="splide__list">
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/2-1.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/2-2.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/2-3.jpg') }}" alt="">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="car">
                                <div class="splide splide--card car__slider">
                                    ...
                                    <div class="splide__track">
                                        <ul class="splide__list">
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/3-1.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/3-2.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/3-3.jpg') }}" alt="">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="car">
                                <div class="splide splide--card car__slider">
                                    ...
                                    <div class="splide__track">
                                        <ul class="splide__list">
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/5-1.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/5-2.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/5-3.jpg') }}" alt="">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="car">
                                <div class="splide splide--card car__slider">
                                    ...
                                    <div class="splide__track">
                                        <ul class="splide__list">
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/6-1.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/6-2.jpg') }}" alt="">
                                            </li>
                                            <li class="splide__slide">
                                                <img src="{{ asset('assets/img/cars/6-3.jpg') }}" alt="">
                                            </li>
                                        </ul>
                                    </div>
                                </div>
