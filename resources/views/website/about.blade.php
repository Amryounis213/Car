            ...
            <div class="row">
                <div class="col-12 col-lg-4">
                    <div class="step">
                        ...
                        <p class="step__text">Register on our platform to access a personalized car rental experience.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="step">
                        ...
                        <p class="step__text">Our algorithm will match you with the best available car rental options.
                        </p>
                    </div>
                </div>
                ...
                <div class="col-12 col-lg-4">
                    <div class="step">
                        ...
                        <p class="step__text">Finalize the rental agreement with the car owner and enjoy your
                            hassle-free ride.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-12 col-xl-11">
                    <div class="main__title">
                        <h2>Team members</h2>
                        <p>From experienced car rental agents to skilled mechanics, our team is committed to providing
                            you with the best car rental experience possible. We value transparency and trust, which is
                            why we have posted photos and brief biographies of our team members on this page. We strive
                            to provide our customers with the highest level of service, and our team is always available
                            to help you with your car rental needs.</p>
                    </div>
                </div>
                <!-- end title -->
            </div>
            ...
            <div class="splide__track">
                <ul class="splide__list">
                    <li class="splide__slide">
                        <div class="testimonial testimonial--carousel">
                            <div class="testimonial__text">
                                <p>«I've been using this car rental service for several years now and I can honestly say
                                    that they always provide me with the best cars at the best prices. Their customer
                                    service is top-notch and I highly recommend them.»</p>
                            </div>
                    ...
                    <li class="splide__slide">
                        <div class="testimonial testimonial--carousel">
                            <div class="testimonial__text">
                                <p>«I rented a car for a weekend trip and was pleasantly surprised with the ease of the
                                    process. The car was clean and in great condition, and the staff was friendly and
                                    helpful. I will definitely be using this service again in the future.»</p>
                            </div>
                    ...
                    <li class="splide__slide">
                        <div class="testimonial testimonial--carousel">
                            <div class="testimonial__text">
                                <p>«I recently had an issue with a rental car and the team at this rental service went
                                    above and beyond to help me out. They were responsive and understanding, and
                                    ultimately resolved my issue in a timely manner.»</p>
                            </div>
                    ...
                    <li class="splide__slide">
                        <div class="testimonial testimonial--carousel">
                            <div class="testimonial__text">
                                <p>«The cars available for rent at this service are always in great condition and
                                    well-maintained. The rental process is simple and straightforward, and I appreciate
                                    the competitive pricing.»</p>
                            </div>
                    ...
                    <li class="splide__slide">
                        <div class="testimonial testimonial--carousel">
                            <div class="testimonial__text">
                                <p>«I had a great experience renting a car from this service. The process was seamless
                                    and efficient, and the staff was friendly and professional. The car was in excellent
                                    condition and I felt safe and secure driving it.»</p>
                            </div>
                    ...
                    <div class="main__title">
                        ...
                        <div class="row">
                            <div class="col-12 col-xl-9">
                                <p>Looking for a reliable car rental? Look no further! Our company offers affordable
                                    prices, full insurance coverage, and support on the road. With minimum bureaucracy,
                                    you can get on the road hassle-free.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="feature">
                        ...
                        <p class="feature__text">We've got you covered with 24/7 support on the road. No matter where
                            you are, we'll be there to help you out.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="feature">
                        ...
                        <p class="feature__text">Our prices are competitive and affordable. We strive to provide the
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="feature">
                        ...
                        <p class="feature__text">We know your time is valuable. That's why we've simplified the rental
                            process and eliminated unnecessary bureaucracy.</p>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-6 col-xl-3">
                    <div class="feature feature--last">
                        ...
                        <p class="feature__text">Drive with peace of mind knowing that our rental cars come with full
                            insurance coverage. You are safe with us.</p>
                    </div>
                </div>
            </div>
        </div>
