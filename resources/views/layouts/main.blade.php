...
@php
    ...
    $dir = $lang == 'ar' ? 'rtl' : 'ltr';
@endphp
<html lang="{{ $lang }}" dir="{{ $dir }}" direction="{{ $dir }}"
    style="direction:{{ $dir }};">
                                ...
                                <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-title-gray-700 menu-icon-muted menu-active-bg menu-state-color fw-semibold py-4 fs-base w-175px"
                                    ...
                                    <div class="menu-item px-3 my-0">
                                        <a href="#" class="menu-link px-3 py-2" data-kt-element="mode"
                                            ...
                                            <span class="menu-title">{{ __('dashboard.light') }}</span>
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                    <!--begin::Menu item-->
                                    <div class="menu-item px-3 my-0">
                                        <a href="#" class="menu-link px-3 py-2" data-kt-element="mode"
                                            ...
                                            <span class="menu-title">{{ __('dashboard.dark') }}</span>
                                        </a>
                                    </div>
                                    <!--end::Menu item-->
                                        ...
                                        <div class="menu-content d-flex align-items-center px-3">
                                            ...
                                            <div class="d-flex flex-column">
                                                <div class="fw-bold d-flex align-items-center fs-5">
                                                    ...
                                                    <span
                                                        class="badge badge-light-success fw-bold fs-8 px-2 py-1 ms-2">{{-- Auth::user()->is_admin?'ادمن':'مستخدم' --}}</span>
                                                </div>
                                                <a href="#"
										...
										<div data-kt-menu-trigger="click" class="menu-item menu-accordion">
											...
											<div class="menu-sub menu-sub-accordion ">
												...
												<div class="menu-item">
													...
													<a class="menu-link {{ (request()->is('admin')) ? 'active' : '' }}" href="{{route('users.name', 1)}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
														<span class="menu-title">تغيير الاسم</span>
													</a>
												 
													<a class="menu-link {{ (request()->is('admin/password')) ? 'active' : '' }}" href="{{route('users.change-password-view', 1)}}">
														<span class="menu-bullet">
															<span class="bullet bullet-dot"></span>
														</span>
