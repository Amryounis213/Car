                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input autocomplete="off" type="text" name="name[{{ $key }}]"
                                            ...
                                            placeholder="{{ $lang }}"
                                            value="{{ old('name.' . $key, $paymenttype->getTranslation('name', $key)) }}">
                     ...
                     <div class="row fv-plugins-icon-container">
                        ...
                        <div class="col-lg-4 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch">
                                ...
                                <input data-id="{{ $paymenttype->id }}" class="form-check-input w-45px h-30px sts-fld"
                                    type="checkbox" id="status_{{ $paymenttype->id }}" name="status" value="1"
                                    {{ old('status', $paymenttype->status ?? '') == 1 ? 'checked' : '' }}>
                            </div>
                        </div>
                    </div>
                    <!--end::Row-->
