                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input id="search" type="text" data-kt-user-table-filter="search"
                                    class="form-control form-control-solid w-250px ps-14" placeholder="ابحث عن بودكاست ( اسم البودكاست او اسم المضيف)" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_table_users">
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-muted fw-bold fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-125px text-start">اسم البرنامج</th>
                                    <th class="min-w-125px text-start">اضيف بواسطة</th>
                                    <th class="min-w-125px text-start">المالك</th>
                                    <th class="min-w-125px text-start">عدد الحلقات</th>
                                    <th class="text-start min-w-100px">الخيارات</th>
                                </tr>
                                <!--end::Table row-->
                            </thead>
                            <!--end::Table head-->
    ...
    <script>
     ...
     <script type="text/javascript">
        $(document).ready(function () {
            ...
            const oTable = $('#kt_table_users').DataTable();
            $(document).on('click', ".del_rec_btn", function (e) {
                e.preventDefault();
                const id = $(this).data('id');
                let url = "{{ route('admin-delete-podcast', ":id") }}";
     ...
     <script>
        $(document).ready(function () {
            let oTable = $('#kt_table_users').DataTable();
