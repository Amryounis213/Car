                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-title">
                            ...
                            <div class="d-flex align-items-center position-relative my-1">
                                ...
                                <input type="text" id="search" class="form-control form-control-solid w-250px ps-14"
                                    placeholder="{{ __('dashboard.search') . ' ' . __('dashboard.navrange') }}" />
                            </div>
                            <!--end::Search-->
                        </div>
                        <!--begin::Card title-->
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
								<a href="{{route('navranges.create')}}" id="showmodal" type="button" class="btn btn-dark" >{{ __('dashboard.add_new_nav') }}</a>     
                            </div>
                            <!--end::Toolbar-->
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', ".del_rec_btn", function(e) {
                ...
                let url = "{{ route('navranges.destroy', ':id') }}";
