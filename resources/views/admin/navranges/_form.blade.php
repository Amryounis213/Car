                   ...
                   <div class="row fv-plugins-icon-container">
                       ...
                       <div class="col-lg-4 d-flex align-items-center">
                           <div class="form-check form-check-solid form-check-custom form-switch">
                               ...
                               <input data-id="{{ $navrange->id }}" class="form-check-input w-45px h-30px sts-fld"
                                   type="checkbox" id="status_{{ $navrange->id }}" name="status" value="1"
                                   {{ old('status', $navrange->status ?? '') == 1 ? 'checked' : '' }}>
