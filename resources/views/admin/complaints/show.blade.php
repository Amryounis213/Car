                ...
                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                    ...
                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                        ...
                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">
                            {{ __('dashboard.show_complaints') }}</h1>
                        <!--end::Title-->
                        <!--begin::Breadcrumb-->
                        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            ...
                            <li class="breadcrumb-item text-muted">
                                <a href=""
                                    class="text-muted text-hover-primary">{{ __('dashboard.communication') }}</a>
                            </li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">{{ __('dashboard.communication') }}</li>
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item">
                                <span class="bullet bg-gray-400 w-5px h-2px"></span>
                            ...
                            <!--end::Item-->
                            <!--begin::Item-->
                            <li class="breadcrumb-item text-muted">{{ __('dashboard.show_complaints') }}</li>
                            <!--end::Item-->
                        </ul>
                        <!--end::Breadcrumb-->
                    </div>
                        ...
                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-12">
                            ...
                            <div class="card card-flush py-4">
                                        ...
                                        <div class="d-flex flex-column-fluid">
                                            ...
                                            <div class="image-input image-input-circle" data-kt-image-input="true">
                                                ...
                                                <div class="image-input-wrapper w-125px h-125px"
                                                    style="background-image: url('{{ asset('storage/' . ($model->User->image ? $model->User->image : ' ')) }}');">
                                                    </div>
                                                    ...
                                                    <div class="mt-3">
                                                        <div class="image-input-wrapper w-200px h-200px">
                                                            <p>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                                Sint fugit nobis laboriosam natus saepe corporis ut quasi
                                                                repellat, molestias voluptatum, aspernatur rem reprehenderit
                                                                dolorum. Et fugiat sed obcaecati nemo eligendi.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="d-flex justify-content-center">
                                    <!--end::Button-->
                                    @include('admin.complaints.parts._status')
                                </div>
                            </div>
                        </div>
                        {{--  Show Driver --}}
