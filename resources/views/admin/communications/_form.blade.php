            ...
            <div class="row mb-2">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input autocomplete="off" type="text" name="title"
                                            ...
                                            {{-- value="{{ old('title', $appconfig->title) }}"> --}}
                                            {{-- value="{{ old('title.' . $key, $appconfig->getTranslation('title', $key)) }}"> --}}
                                        <div class="fv-plugins-message-container invalid-feedback"></div>
                                        @error('title')
                            ...
                            <label class="col-lg-2 col-form-label required fw-bold fs-6">{{ __('dashboard.taxprice') }}</label>
                            <div class="col-lg-4">
                            ...
                            <label class="col-lg-2 col-form-label required fw-bold fs-6">{{ __('dashboard.cancel_order_tax') }}</label>
                            <div class="col-lg-4">
                                <input type="number" name="cancel_order_tax"
                                    class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 name"
                                    placeholder="{{ __('dashboard.cancel_order_tax') }}" value="{{ $appconfig->cancel_order_tax }}">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                            <label class="col-lg-2 col-form-label required fw-bold fs-6">{{ __('dashboard.order_duration') }}</label>
                            <div class="col-lg-4">
                                <input type="number" name="order_duration"
                                    class="form-control form-control-lg form-control-solid mb-3 mb-lg-0 name"
                                    placeholder="{{ __('dashboard.order_duration') }}" value="{{ $appconfig->order_duration }}">
                                <div class="fv-plugins-message-container invalid-feedback"></div>
                            </div>
                    </div>
