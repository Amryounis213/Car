                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input autocomplete="off" type="text" name="name[{{ $key }}]"
                                            ...
                                            placeholder="{{ $lang }}"
                                            value="{{ old('name.' . $key, $revisiontype->getTranslation('name', $key)) }}">
                    ...
                    <div class="row fv-plugins-icon-container">
                        ...
                        <div class="col-lg-4 d-flex align-items-center">
                            <div class="form-check form-check-solid form-check-custom form-switch">
                                ...
                                <input data-id="{{ $revisiontype->id }}" class="form-check-input w-45px h-30px sts-fld"
                                    type="checkbox" id="status_{{ $revisiontype->id }}" name="status" value="1"
                                    {{ old('status', $revisiontype->status ?? '') == 1 ? 'checked' : '' }}>
