                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                                <a href="{{ route('revisiontypes.create') }}" id="showmodal" type="button"
...
@section('scripts')
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', ".del_rec_btn", function(e) {
                ...
                let url = "{{ route('revisiontypes.destroy', ':id') }}";
    ...
    <script>
        $(document).on('click', '.sts-fld', function(e) {
            ...
            $.ajax({
                type: "POST",
                url: "{{ route('revisiontypes.status') }}",
                data: {
                    'id': id
                },
                success: function(data) {
