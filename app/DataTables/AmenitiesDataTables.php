...
class AmenitiesDataTables extends DataTable
{
    ...
    public function dataTable($query): EloquentDataTable
    {
        return datatables()
            ->eloquent($query)
            ->addIndexColumn()
            ->addColumn('name', function (Amenity $model) {
                return view('admin.amenities.parts._name', compact('model'));
            })
            ->addColumn('status', function (Amenity $model) {
                return view('admin.amenities.parts._status', compact('model'));
            })
            ->addColumn('action', function (Amenity $model) {
                return view('admin.amenities.parts._action-menu', compact('model'));
            });
    }
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::computed('name')->title(__('dashboard.name'))->addClass('text-start'),
